...
- 「本」はコンテナ等を数える語。コンテナ単位を持つ餌では「1本」＝「1コンテナ」とする（個ではない）。
...
- 【単位「本」】「本」はコンテナ等を数える語。**コンテナ単位を持つ餌では「1本」「各1本」＝「1コンテナ」**とする（個ではない）。例「サイレージ 赤坂 本場 各1本」→ 各農場 units=[{"unit":"コンテナ","n":1}]。「各N本」は各農場それぞれ Nコンテナ。
